...
import server.database.DistancesAccessor;
...
public class PathCalculator
{
	...
	private final DistancesAccessor accessor;
	...
	public PathCalculator( String from, String to ) {
		accessor = new DistancesAccessor();
	...
	public List<String> calculate() {
		...
		if( d( to ) == DistancesAccessor.INFINITY ) {
	...
	private Integer d( String city ) {
		if( !distances.containsKey( city ) ) return DistancesAccessor.INFINITY;
